...
from penzai.experimental.v2.core import variables as vars_lib
...
class Layer(struct.Struct, abc.ABC):
  ...
  def __penzai_repr__(self, path: str | None, subtree_renderer: Any):
    from penzai.experimental.v2.nn._treescope_handlers import layer_handler  # pylint: disable=g-import-not-at-top
